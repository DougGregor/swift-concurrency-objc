...
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "CMTimebaseCopyMasterTimebase(_:)")
func CMTimebaseGetMasterTimebase(_ timebase: CMTimebase) -> CMTimebase?
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "CMTimebaseCopyMasterClock(_:)")
func CMTimebaseGetMasterClock(_ timebase: CMTimebase) -> CMClock?
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "CMTimebaseCopyMaster(_:)")
func CMTimebaseGetMaster(_ timebase: CMTimebase) -> CMClockOrTimebase?
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "CMTimebaseCopyUltimateMasterClock(_:)")
