...
@available(tvOS, introduced: 3.2, deprecated: 8.0, renamed: "NSAttributedString.Key.backgroundColor")
let UITextInputTextBackgroundColorKey: String
@available(tvOS, introduced: 3.2, deprecated: 8.0, renamed: "NSAttributedString.Key.foregroundColor")
let UITextInputTextColorKey: String
@available(tvOS, introduced: 3.2, deprecated: 8.0, renamed: "NSAttributedString.Key.font")
