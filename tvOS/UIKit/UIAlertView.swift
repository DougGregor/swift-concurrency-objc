...
@available(tvOS, introduced: 2.0, deprecated: 9.0, message: "UIAlertView is deprecated. Use UIAlertController with a preferredStyle of UIAlertControllerStyleAlert instead")
...
protocol UIAlertViewDelegate : NSObjectProtocol {
  @available(tvOS, introduced: 2.0, deprecated: 9.0, message: "Use UIAlertController instead.")
