...
extension UIView {
  ...
  @available(tvOS 4.0, *)
  class func animateAsync(withDuration duration: TimeInterval, delay: TimeInterval, options: UIView.AnimationOptions = [], animations: @escaping () -> Void) async -> Bool
  @available(tvOS 4.0, *)
  ...
  @available(tvOS 7.0, *)
  class func animateAsync(withDuration duration: TimeInterval, delay: TimeInterval, usingSpringWithDamping dampingRatio: CGFloat, initialSpringVelocity velocity: CGFloat, options: UIView.AnimationOptions = [], animations: @escaping () -> Void) async -> Bool
  @available(tvOS 4.0, *)
  ...
  @available(tvOS 4.0, *)
  class func transitionAsync(with view: UIView, duration: TimeInterval, options: UIView.AnimationOptions = [], animations: (() -> Void)?) async -> Bool
  @available(tvOS 4.0, *)
  ...
  @available(tvOS 4.0, *)
  class func transitionAsync(from fromView: UIView, to toView: UIView, duration: TimeInterval, options: UIView.AnimationOptions = []) async -> Bool
  @available(tvOS 7.0, *)
  ...
  @available(tvOS 7.0, *)
  class func performSystemAnimationAsync(_ animation: UIView.SystemAnimation, on views: [UIView], options: UIView.AnimationOptions = [], animations parallelAnimations: (() -> Void)?) async -> Bool
  @available(tvOS 12.0, *)
...
extension UIView {
  ...
  @available(tvOS 7.0, *)
  class func animateKeyframesAsync(withDuration duration: TimeInterval, delay: TimeInterval, options: UIView.KeyframeAnimationOptions = [], animations: @escaping () -> Void) async -> Bool
  @available(tvOS 7.0, *)
