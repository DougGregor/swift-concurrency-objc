...
@available(tvOS, introduced: 9.0, deprecated: 13.0, message: "GCExtendedGamepadSnapshot has been deprecated, use [GCController controllerWithExtendedGamepad] instead")
