...
extension NSLinguisticTagScheme {
  @available(tvOS, introduced: 9.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
...
class NSLinguisticTagger : NSObject {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
  var string: String?
  @available(tvOS, introduced: 11.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
