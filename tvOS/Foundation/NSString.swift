...
extension NSString {
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -cStringUsingEncoding: instead")
  func cString() -> UnsafePointer<CChar>?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -cStringUsingEncoding: instead")
  func lossyCString() -> UnsafePointer<CChar>?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -lengthOfBytesUsingEncoding: instead")
  func cStringLength() -> Int
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -getCString:maxLength:encoding: instead")
  ...
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -writeToFile:atomically:error: instead")
  func write(toFile path: String, atomically useAuxiliaryFile: Bool) -> Bool
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -writeToURL:atomically:error: instead")
  func write(to url: URL, atomically: Bool) -> Bool
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -initWithContentsOfFile:encoding:error: instead")
  convenience init?(contentsOfFile path: String)
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -initWithContentsOfURL:encoding:error: instead")
  convenience init?(contentsOf url: URL)
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use +stringWithContentsOfFile:encoding:error: instead")
  class func string(withContentsOfFile path: String) -> Any?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use +stringWithContentsOfURL:encoding:error: instead")
  class func string(withContentsOf url: URL) -> Any?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -initWithCString:encoding: instead")
  ...
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use +stringWithCString:encoding:")
  class func string(withCString bytes: UnsafePointer<CChar>, length: Int) -> Any?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use +stringWithCString:encoding: instead")
