...
extension NSCalendar {
  ...
  struct Unit : OptionSet {
    ...
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.era")
    static var NSEraCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.year")
    static var NSYearCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.month")
    static var NSMonthCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.day")
    static var NSDayCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.hour")
    static var NSHourCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.minute")
    static var NSMinuteCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.second")
    static var NSSecondCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "NSCalendarUnitWeekOfMonth or NSCalendarUnitWeekOfYear, depending on which you mean")
    static var NSWeekCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.weekday")
    static var NSWeekdayCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.weekdayOrdinal")
    static var NSWeekdayOrdinalCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.quarter")
    static var NSQuarterCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.weekOfMonth")
    static var NSWeekOfMonthCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.weekOfYear")
    static var NSWeekOfYearCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.yearForWeekOfYear")
    static var NSYearForWeekOfYearCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.calendar")
    static var NSCalendarCalendarUnit: NSCalendar.Unit { get }
    @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Unit.timeZone")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Options.wrapComponents")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSDateComponentUndefined")
...
class NSDateComponents : NSObject, NSCopying, NSSecureCoding {
  ...
  @available(tvOS 9.0, *)
  var date: Date? { get }
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -weekOfMonth or -weekOfYear, depending on which you mean")
  func week() -> Int
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -setWeekOfMonth: or -setWeekOfYear:, depending on which you mean")
