...
class NSKeyedArchiver : NSCoder {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Use -initRequiringSecureCoding: instead")
  init(forWritingWith data: NSMutableData)
  @available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Use +archivedDataWithRootObject:requiringSecureCoding:error: instead")
  class func archivedData(withRootObject rootObject: Any) -> Data
  @available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Use +archivedDataWithRootObject:requiringSecureCoding:error: and -writeToURL:options:error: instead")
...
class NSKeyedUnarchiver : NSCoder {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Use -initForReadingFromData:error: instead")
  init(forReadingWith data: Data)
  @available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Use +unarchivedObjectOfClass:fromData:error: instead")
