...
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.gregorian")
let NSGregorianCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.buddhist")
let NSBuddhistCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.chinese")
let NSChineseCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.hebrew")
let NSHebrewCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.islamic")
let NSIslamicCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.islamicCivil")
let NSIslamicCivilCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.japanese")
let NSJapaneseCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.republicOfChina")
let NSRepublicOfChinaCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.persian")
let NSPersianCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.indian")
let NSIndianCalendar: String
@available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "NSCalendar.Identifier.ISO8601")
