...
class FileManager : NSObject {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -attributesOfItemAtPath:error: instead")
  func fileAttributes(atPath path: String, traverseLink yorn: Bool) -> [AnyHashable : Any]?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -setAttributes:ofItemAtPath:error: instead")
  func changeFileAttributes(_ attributes: [AnyHashable : Any] = [:], atPath path: String) -> Bool
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -contentsOfDirectoryAtPath:error: instead")
  func directoryContents(atPath path: String) -> [Any]?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -attributesOfFileSystemForPath:error: instead")
  func fileSystemAttributes(atPath path: String) -> [AnyHashable : Any]?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -destinationOfSymbolicLinkAtPath:error:")
  func pathContentOfSymbolicLink(atPath path: String) -> String?
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -createSymbolicLinkAtPath:error: instead")
  func createSymbolicLink(atPath path: String, pathContent otherpath: String) -> Bool
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use -createDirectoryAtPath:withIntermediateDirectories:attributes:error: instead")
...
extension NSObject {
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: " Handler API no longer supported")
