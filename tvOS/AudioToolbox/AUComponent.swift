...
@available(tvOS, introduced: 9.0, deprecated: 13.0, renamed: "kAudioUnitSubType_NewTimePitch")
...
@available(tvOS, introduced: 9.0, deprecated: 13.0, message: "Inter-App Audio API is deprecated in favor of Audio Units")
