...
struct TKError : _BridgedStoredNSError {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "TKError.authenticationFailed")
  static var TKErrorAuthenticationFailed: TKError.Code { get }
  @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "TKError.objectNotFound")
  static var TKErrorObjectNotFound: TKError.Code { get }
  @available(tvOS, introduced: 9.0, deprecated: 9.0, renamed: "TKError.tokenNotFound")
