...
enum CFURLPathStyle : CFIndex {
  ...
  @available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Carbon File Manager is deprecated, use kCFURLPOSIXPathStyle where possible")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use [NSString stringByRemovingPercentEncoding] or CFURLCreateStringByReplacingPercentEscapes() instead, which always uses the recommended UTF-8 encoding.")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use [NSString stringByAddingPercentEncodingWithAllowedCharacters:] instead, which always uses the recommended UTF-8 encoding, and which encodes for a specific URL component or subcomponent (since each URL component or subcomponent has different rules for what characters are valid).")
...
@available(tvOS, introduced: 9.0, deprecated: 10.0, message: "Use NSURLLabelColorKey")
let kCFURLLabelColorKey: CFString!
@available(tvOS 9.0, *)
let kCFURLLocalizedLabelKey: CFString!
@available(tvOS, introduced: 9.0, deprecated: 10.0, message: "Use NSURLEffectiveIconKey")
let kCFURLEffectiveIconKey: CFString!
@available(tvOS, introduced: 9.0, deprecated: 10.0, message: "Use NSURLCustomIconKey")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use kCFURLUbiquitousItemDownloadingStatusKey instead")
...
@available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use NSMetadataQuery and NSMetadataUbiquitousItemPercentDownloadedKey on NSMetadataItem instead")
let kCFURLUbiquitousItemPercentDownloadedKey: CFString!
@available(tvOS, introduced: 9.0, deprecated: 9.0, message: "Use NSMetadataQuery and NSMetadataUbiquitousItemPercentUploadedKey on NSMetadataItem instead")
