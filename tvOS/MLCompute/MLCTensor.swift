...
class MLCTensor : NSObject, NSCopying {
  ...
  @available(tvOS, introduced: 14.0, deprecated: 14.0, message: "Please use -bindOptimizerData:deviceData: instead")
  func optimizerData(_ optimizerData: [MLCTensorData]) -> Bool
