...
extension INSearchForNotebookItemsIntent {
  @available(tvOS, introduced: 11.0, deprecated: 11.2, message: "Use the designated initializer instead")
  ...
  @available(tvOS, introduced: 11.2, deprecated: 13.0, message: "Use the designated initializer instead")
