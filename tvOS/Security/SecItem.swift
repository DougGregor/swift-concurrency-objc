...
@available(tvOS, introduced: 4.0, deprecated: 12.0, message: "Use an accessibility level that provides some user protection, such as kSecAttrAccessibleAfterFirstUnlock")
...
@available(tvOS, introduced: 4.0, deprecated: 12.0, message: "Use an accessibility level that provides some user protection, such as kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly")
...
@available(tvOS, introduced: 9.0, deprecated: 12.0, message: "Not implemented on this platform")
let kSecUseItemList: CFString
@available(tvOS, introduced: 8.0, deprecated: 14.0, message: "Use kSecUseAuthenticationContext and set LAContext.localizedReason property")
let kSecUseOperationPrompt: CFString
@available(tvOS, introduced: 8.0, deprecated: 9.0, message: "Use kSecUseAuthenticationUI instead.")
...
@available(tvOS, introduced: 9.0, deprecated: 14.0, message: "Instead of kSecUseAuthenticationUI, use kSecUseAuthenticationContext and set LAContext.interactionNotAllowed property")
