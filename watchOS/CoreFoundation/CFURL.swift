...
enum CFURLPathStyle : CFIndex {
  ...
  @available(watchOS, introduced: 2.0, deprecated: 2.0, message: "Carbon File Manager is deprecated, use kCFURLPOSIXPathStyle where possible")
...
@available(watchOS, introduced: 2.0, deprecated: 3.0, message: "Use NSURLLabelColorKey")
let kCFURLLabelColorKey: CFString!
@available(watchOS 2.0, *)
let kCFURLLocalizedLabelKey: CFString!
@available(watchOS, introduced: 2.0, deprecated: 3.0, message: "Use NSURLEffectiveIconKey")
let kCFURLEffectiveIconKey: CFString!
@available(watchOS, introduced: 2.0, deprecated: 3.0, message: "Use NSURLCustomIconKey")
