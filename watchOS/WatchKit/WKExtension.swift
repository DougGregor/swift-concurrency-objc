...
protocol WKExtensionDelegate : NSObjectProtocol {
  ...
  @asyncHandler optional func applicationDidBecomeActive()
  ...
  @available(watchOS 4.0, *)
  @asyncHandler optional func deviceOrientationDidChange()
  @available(watchOS 6.0, *)
  @asyncHandler optional func didRegisterForRemoteNotifications(withDeviceToken deviceToken: Data)
  @available(watchOS 6.0, *)
  @asyncHandler optional func didFailToRegisterForRemoteNotificationsWithError(_ error: Error)
  @available(watchOS 6.0, *)
  ...
  @available(watchOS 2.0, *)
  @available(watchOS, deprecated: 3.0, message: "use UNUserNotificationCenterDelegate")
  @asyncHandler optional func didReceiveRemoteNotification(_ userInfo: [AnyHashable : Any])
  @available(watchOS 2.0, *)
  @available(watchOS, deprecated: 3.0, message: "use UNUserNotificationCenterDelegate")
