...
class NSKeyedArchiver : NSCoder {
  ...
  @available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use -initRequiringSecureCoding: instead")
  init(forWritingWith data: NSMutableData)
  @available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use +archivedDataWithRootObject:requiringSecureCoding:error: instead")
  class func archivedData(withRootObject rootObject: Any) -> Data
  @available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use +archivedDataWithRootObject:requiringSecureCoding:error: and -writeToURL:options:error: instead")
...
class NSKeyedUnarchiver : NSCoder {
  ...
  @available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use -initForReadingFromData:error: instead")
  init(forReadingWith data: Data)
  @available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use +unarchivedObjectOfClass:fromData:error: instead")
