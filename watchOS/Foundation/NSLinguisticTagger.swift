...
extension NSLinguisticTagScheme {
  @available(watchOS, introduced: 2.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
...
class NSLinguisticTagger : NSObject {
  ...
  @available(watchOS, introduced: 2.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
  var string: String?
  @available(watchOS, introduced: 4.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
