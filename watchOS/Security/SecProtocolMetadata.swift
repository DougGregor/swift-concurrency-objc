...
@available(watchOS, introduced: 5.0, deprecated: 6.0, renamed: "sec_protocol_metadata_get_negotiated_tls_protocol_version(_:)")
...
@available(watchOS, introduced: 5.0, deprecated: 6.0, renamed: "sec_protocol_metadata_get_negotiated_tls_ciphersuite(_:)")
