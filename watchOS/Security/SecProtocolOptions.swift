...
@available(watchOS, introduced: 5.0, deprecated: 6.0, message: "Use sec_protocol_options_append_tls_ciphersuite")
...
@available(watchOS, introduced: 5.0, deprecated: 6.0, message: "Use sec_protocol_options_append_tls_ciphersuite_group")
func sec_protocol_options_add_tls_ciphersuite_group(_ options: sec_protocol_options_t, _ group: SSLCiphersuiteGroup)
@available(watchOS, introduced: 5.0, deprecated: 6.0, renamed: "sec_protocol_options_set_min_tls_protocol_version(_:_:)")
...
@available(watchOS, introduced: 5.0, deprecated: 6.0, renamed: "sec_protocol_options_set_max_tls_protocol_version(_:_:)")
...
@available(watchOS, introduced: 5.0, deprecated: 6.0, message: "DHE ciphersuites are no longer supported")
...
func sec_protocol_options_set_peer_authentication_optional(_ options: sec_protocol_options_t, _ peer_authentication_optional: Bool)
