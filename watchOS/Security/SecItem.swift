...
@available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use an accessibility level that provides some user protection, such as kSecAttrAccessibleAfterFirstUnlock")
...
@available(watchOS, introduced: 2.0, deprecated: 5.0, message: "Use an accessibility level that provides some user protection, such as kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly")
...
@available(watchOS, introduced: 1.0, deprecated: 5.0, message: "Not implemented on this platform")
let kSecUseItemList: CFString
@available(watchOS, introduced: 2.0, deprecated: 7.0, message: "Use kSecUseAuthenticationContext and set LAContext.localizedReason property")
let kSecUseOperationPrompt: CFString
@available(watchOS, introduced: 2.0, deprecated: 2.0, message: "Use kSecUseAuthenticationUI instead.")
...
@available(watchOS, introduced: 2.0, deprecated: 7.0, message: "Instead of kSecUseAuthenticationUI, use kSecUseAuthenticationContext and set LAContext.interactionNotAllowed property")
