...
@available(watchOS, introduced: 2.0, deprecated: 4.0, message: "No longer supported. Use Network.framework.")
let kSSLSessionConfig_default: CFString
@available(watchOS, introduced: 2.0, deprecated: 6.0, message: "No longer supported. Use Network.framework.")
...
@available(watchOS, introduced: 3.0, deprecated: 6.0, message: "No longer supported. Use Network.framework.")
...
@available(watchOS, introduced: 4.0, deprecated: 6.0, message: "No longer supported. Use Network.framework.")
...
@available(watchOS, introduced: 2.0, deprecated: 2.0, message: "No longer supported. Use Network.framework.")
