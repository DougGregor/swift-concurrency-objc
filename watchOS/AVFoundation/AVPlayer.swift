...
extension AVPlayer {
  @available(watchOS, introduced: 2.0, deprecated: 4.0, message: "Allow AVPlayer to enable closed captions automatically according to user preferences by ensuring that the value of appliesMediaSelectionCriteriaAutomatically is YES.")
