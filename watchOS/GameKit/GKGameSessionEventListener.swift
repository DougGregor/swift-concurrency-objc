...
@available(watchOS, introduced: 3.0, deprecated: 5.0, message: "Use GKLocalPlayerListener for multiplayer event notifications.")
...
extension GKGameSession {
  @available(watchOS, introduced: 3.0, deprecated: 5.0, message: "Use GKLocalPlayer's registerListener: to register for GKLocalPlayerListener event notifications.")
  class func add(listener: GKGameSessionEventListener)
  @available(watchOS, introduced: 3.0, deprecated: 5.0, message: "Use GKLocalPlayer's unregisterListener: or unregisterAllListeners to unregister from GKLocalPlayerListener event notifications.")
