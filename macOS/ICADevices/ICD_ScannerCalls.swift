...
typealias __ICD_ScannerOpenUSBDeviceWithIORegPath = @convention(c) (UInt32, UnsafeMutablePointer<CChar>?, UnsafeMutablePointer<ScannerObjectInfo>?) -> ICAError
typealias __ICD_ScannerOpenFireWireDevice = @convention(c) (UInt64, UnsafeMutablePointer<ScannerObjectInfo>?) -> ICAError
typealias __ICD_ScannerOpenFireWireDeviceWithIORegPath = @convention(c) (UInt64, UnsafeMutablePointer<CChar>?, UnsafeMutablePointer<ScannerObjectInfo>?) -> ICAError
...
typealias __ICD_ScannerGetPropertyData = @convention(c) (UnsafePointer<ScannerObjectInfo>?, UnsafeMutableRawPointer?) -> ICAError
typealias __ICD_ScannerSetPropertyData = @convention(c) (UnsafePointer<ScannerObjectInfo>?, UnsafeRawPointer?) -> ICAError
...
typealias __ICD_ScannerReadFileData64 = @convention(c) (UnsafePointer<ScannerObjectInfo>?, UInt32, Ptr?, UInt64, UnsafeMutablePointer<UInt64>?) -> ICAError
typealias __ICD_ScannerWriteFileData = @convention(c) (UnsafePointer<ScannerObjectInfo>?, UnsafePointer<CChar>?, UInt32, Ptr?, UInt32, UnsafeMutablePointer<UInt32>?) -> ICAError
...
func ICD_ScannerMain(_ argc: Int32, _ argv: UnsafeMutablePointer<UnsafePointer<CChar>?>!) -> Int32
func ICDScannerGetStandardPropertyData(_ objectInfo: UnsafePointer<ScannerObjectInfo>!, _ pb: UnsafeMutableRawPointer!) -> ICAError
...
func ICDScannerCopyDeviceInfoDictionary(_ deviceName: UnsafePointer<CChar>!, _ theDict: UnsafeMutablePointer<Unmanaged<CFDictionary>?>!) -> ICAError
...
func ICDScannerConnectUSBDeviceWithIORegPath(_ locationID: UInt32, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDScannerDisconnectUSBDevice(_ locationID: UInt32) -> ICAError
func ICDScannerDisconnectUSBDeviceWithIORegPath(_ locationID: UInt32, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDScannerConnectFWDevice(_ guid: UInt64) -> ICAError
func ICDScannerConnectFWDeviceWithIORegPath(_ guid: UInt64, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDScannerDisconnectFWDevice(_ guid: UInt64) -> ICAError
func ICDScannerDisconnectFWDeviceWithIORegPath(_ guid: UInt64, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
