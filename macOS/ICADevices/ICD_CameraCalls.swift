...
typealias __ICD_OpenUSBDeviceWithIORegPath = @convention(c) (UInt32, UnsafeMutablePointer<CChar>?, UnsafeMutablePointer<ObjectInfo>?) -> ICAError
typealias __ICD_OpenFireWireDevice = @convention(c) (UInt64, UnsafeMutablePointer<ObjectInfo>?) -> ICAError
typealias __ICD_OpenFireWireDeviceWithIORegPath = @convention(c) (UInt64, UnsafeMutablePointer<CChar>?, UnsafeMutablePointer<ObjectInfo>?) -> ICAError
...
typealias __ICD_GetPropertyData = @convention(c) (UnsafePointer<ObjectInfo>?, UnsafeMutableRawPointer?) -> ICAError
typealias __ICD_SetPropertyData = @convention(c) (UnsafePointer<ObjectInfo>?, UnsafeRawPointer?) -> ICAError
...
typealias __ICD_WriteFileData = @convention(c) (UnsafePointer<ObjectInfo>?, UnsafePointer<CChar>?, UInt32, Ptr?, UInt32, UnsafeMutablePointer<UInt32>?) -> ICAError
...
typealias __ICD_ReadFileData64 = @convention(c) (UnsafePointer<ObjectInfo>?, UInt32, Ptr?, UInt64, UnsafeMutablePointer<UInt64>?) -> ICAError
func ICD_main(_ argc: Int32, _ argv: UnsafeMutablePointer<UnsafePointer<CChar>?>!) -> Int32
func ICDGetStandardPropertyData(_ objectInfo: UnsafePointer<ObjectInfo>!, _ pb: UnsafeMutableRawPointer!) -> ICAError
...
func ICDCopyDeviceInfoDictionary(_ deviceName: UnsafePointer<CChar>!, _ theDict: UnsafeMutablePointer<Unmanaged<CFDictionary>?>!) -> ICAError
...
func ICDConnectUSBDeviceWithIORegPath(_ locationID: UInt32, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDDisconnectUSBDevice(_ locationID: UInt32) -> ICAError
func ICDDisconnectUSBDeviceWithIORegPath(_ locationID: UInt32, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDConnectFWDevice(_ guid: UInt64) -> ICAError
func ICDConnectFWDeviceWithIORegPath(_ guid: UInt64, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
func ICDDisconnectFWDevice(_ guid: UInt64) -> ICAError
func ICDDisconnectFWDeviceWithIORegPath(_ guid: UInt64, _ ioregPath: UnsafeMutablePointer<CChar>!) -> ICAError
