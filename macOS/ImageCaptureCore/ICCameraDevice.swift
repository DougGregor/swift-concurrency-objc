...
protocol ICCameraDeviceDelegate : ICDeviceDelegate {
  @available(macOS 10.4, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didAdd items: [ICCameraItem])
  @available(macOS 10.4, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didRemove items: [ICCameraItem])
  @available(macOS 10.15, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didReceiveThumbnail thumbnail: CGImage?, for item: ICCameraItem, error: Error?)
  @available(macOS 10.15, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didReceiveMetadata metadata: [AnyHashable : Any]?, for item: ICCameraItem, error: Error?)
  @available(macOS 10.4, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didRenameItems items: [ICCameraItem])
  @available(macOS 10.4, *)
  @asyncHandler func cameraDeviceDidChangeCapability(_ camera: ICCameraDevice)
  @available(macOS 10.4, *)
  @asyncHandler func cameraDevice(_ camera: ICCameraDevice, didReceivePTPEvent eventData: Data)
  @available(macOS 10.4, *)
  @asyncHandler func deviceDidBecomeReady(withCompleteContentCatalog device: ICCameraDevice)
  @available(macOS 10.4, *)
  @asyncHandler func cameraDeviceDidRemoveAccessRestriction(_ device: ICDevice)
  @available(macOS 10.4, *)
  @asyncHandler func cameraDeviceDidEnableAccessRestriction(_ device: ICDevice)
  @available(macOS 10.4, *)
  ...
  @available(macOS 10.4, *)
  @asyncHandler optional func cameraDevice(_ camera: ICCameraDevice, didCompleteDeleteFilesWithError error: Error?)
  @available(macOS, introduced: 10.4, deprecated: 10.15)
  @asyncHandler optional func cameraDevice(_ camera: ICCameraDevice, didAdd item: ICCameraItem)
  @available(macOS, introduced: 10.4, deprecated: 10.15)
  @asyncHandler optional func cameraDevice(_ camera: ICCameraDevice, didRemove item: ICCameraItem)
  @available(macOS, introduced: 10.4, deprecated: 10.15)
  @asyncHandler optional func cameraDevice(_ camera: ICCameraDevice, didReceiveThumbnailFor item: ICCameraItem)
  @available(macOS, introduced: 10.4, deprecated: 10.15)
  @asyncHandler optional func cameraDevice(_ camera: ICCameraDevice, didReceiveMetadataFor item: ICCameraItem)
}
protocol ICCameraDeviceDownloadDelegate : NSObjectProtocol {
  ...
  @available(macOS 10.4, *)
  @asyncHandler optional func didReceiveDownloadProgress(for file: ICCameraFile, downloadedBytes: off_t, maxBytes: off_t)
}
