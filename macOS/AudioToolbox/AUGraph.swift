...
@available(macOS, introduced: 10.0, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
func NewAUGraph(_ outGraph: UnsafeMutablePointer<AUGraph?>) -> OSStatus
@available(macOS, introduced: 10.0, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
func DisposeAUGraph(_ inGraph: AUGraph) -> OSStatus
@available(macOS, introduced: 10.5, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
...
@available(macOS, introduced: 10.2, deprecated: 100000, message: "no longer supported")
...
@available(macOS, introduced: 10.1, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
func AUGraphGetCPULoad(_ inGraph: AUGraph, _ outAverageCPULoad: UnsafeMutablePointer<Float32>) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
func AUGraphGetMaxCPULoad(_ inGraph: AUGraph, _ outMaxLoad: UnsafeMutablePointer<Float32>) -> OSStatus
@available(macOS, introduced: 10.2, deprecated: 100000, message: "AUGraph is deprecated in favor of AVAudioEngine")
