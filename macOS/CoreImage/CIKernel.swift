...
class CIKernel : NSObject {
  @available(macOS, introduced: 10.4, deprecated: 10.14, message: "Core Image Kernel Language API deprecated. (Define CI_SILENCE_GL_DEPRECATION to silence these warnings)")
  class func makeKernels(source string: String) -> [CIKernel]?
  @available(macOS, introduced: 10.10, deprecated: 10.14, message: "Core Image Kernel Language API deprecated. (Define CI_SILENCE_GL_DEPRECATION to silence these warnings)")
