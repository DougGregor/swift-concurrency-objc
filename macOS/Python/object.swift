...
var Py_INVALID_SIZE: Py_ssize_t { get }
struct _object {
...
typealias getreadbufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Int32, UnsafeMutablePointer<UnsafeMutableRawPointer?>?) -> Int32
typealias getwritebufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Int32, UnsafeMutablePointer<UnsafeMutableRawPointer?>?) -> Int32
typealias getsegcountproc = @convention(c) (UnsafeMutablePointer<PyObject>?, UnsafeMutablePointer<Int32>?) -> Int32
typealias getcharbufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Int32, UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>?) -> Int32
typealias readbufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Py_ssize_t, UnsafeMutablePointer<UnsafeMutableRawPointer?>?) -> Py_ssize_t
typealias writebufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Py_ssize_t, UnsafeMutablePointer<UnsafeMutableRawPointer?>?) -> Py_ssize_t
typealias segcountproc = @convention(c) (UnsafeMutablePointer<PyObject>?, UnsafeMutablePointer<Py_ssize_t>?) -> Py_ssize_t
typealias charbufferproc = @convention(c) (UnsafeMutablePointer<PyObject>?, Py_ssize_t, UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>?) -> Py_ssize_t
struct bufferinfo {
  ...
  var readonly: Int32
  var ndim: Int32
  var format: UnsafeMutablePointer<CChar>!
  ...
  var `internal`: UnsafeMutableRawPointer!
  init()
  init(buf: UnsafeMutableRawPointer!, obj: UnsafeMutablePointer<PyObject>!, len: Py_ssize_t, itemsize: Py_ssize_t, readonly: Int32, ndim: Int32, format: UnsafeMutablePointer<CChar>!, shape: UnsafeMutablePointer<Py_ssize_t>!, strides: UnsafeMutablePointer<Py_ssize_t>!, suboffsets: UnsafeMutablePointer<Py_ssize_t>!, smalltable: (Py_ssize_t, Py_ssize_t), internal: UnsafeMutableRawPointer!)
}
...
var PyBUF_STRIDES: Int32 { get }
var PyBUF_C_CONTIGUOUS: Int32 { get }
var PyBUF_F_CONTIGUOUS: Int32 { get }
var PyBUF_ANY_CONTIGUOUS: Int32 { get }
var PyBUF_INDIRECT: Int32 { get }
var PyBUF_CONTIG: Int32 { get }
var PyBUF_CONTIG_RO: Int32 { get }
var PyBUF_STRIDED: Int32 { get }
var PyBUF_STRIDED_RO: Int32 { get }
var PyBUF_RECORDS_RO: Int32 { get }
var PyBUF_FULL_RO: Int32 { get }
...
typealias visitproc = @convention(c) (UnsafeMutablePointer<PyObject>?, UnsafeMutableRawPointer?) -> Int32
typealias traverseproc = @convention(c) (UnsafeMutablePointer<PyObject>?, visitproc?, UnsafeMutableRawPointer?) -> Int32
...
typealias getattrfunc = @convention(c) (UnsafeMutablePointer<PyObject>?, UnsafeMutablePointer<CChar>?) -> UnsafeMutablePointer<PyObject>?
...
typealias setattrfunc = @convention(c) (UnsafeMutablePointer<PyObject>?, UnsafeMutablePointer<CChar>?, UnsafeMutablePointer<PyObject>?) -> Int32
...
struct _typeobject {
  ...
  var ob_type: UnsafeMutablePointer<_typeobject>!
  var ob_size: Py_ssize_t
  var tp_name: UnsafePointer<CChar>!
  ...
  var tp_flags: Int
  var tp_doc: UnsafePointer<CChar>!
...
func _PyObject_LookupSpecial(_: UnsafeMutablePointer<PyObject>!, _: UnsafeMutablePointer<CChar>!, _: UnsafeMutablePointer<UnsafeMutablePointer<PyObject>?>!) -> UnsafeMutablePointer<PyObject>!
...
func PyObject_GetAttrString(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyObject_SetAttrString(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!, _: UnsafeMutablePointer<PyObject>!) -> Int32
func PyObject_HasAttrString(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> Int32
...
func _Py_HashPointer(_: UnsafeMutableRawPointer!) -> Int
