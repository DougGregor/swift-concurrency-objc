...
func PyInt_FromString(_: UnsafeMutablePointer<CChar>!, _: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>!, _: Int32) -> UnsafeMutablePointer<PyObject>!
...
func PyOS_strtoul(_: UnsafeMutablePointer<CChar>!, _: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>!, _: Int32) -> UInt
func PyOS_strtol(_: UnsafeMutablePointer<CChar>!, _: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>!, _: Int32) -> Int
...
func _PyInt_FormatAdvanced(_ obj: UnsafeMutablePointer<PyObject>!, _ format_spec: UnsafeMutablePointer<CChar>!, _ format_spec_len: Py_ssize_t) -> UnsafeMutablePointer<PyObject>!
