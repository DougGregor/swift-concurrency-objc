...
func _PySlice_Unpack(_ slice: UnsafeMutablePointer<PyObject>!, _ start: UnsafeMutablePointer<Py_ssize_t>!, _ stop: UnsafeMutablePointer<Py_ssize_t>!, _ step: UnsafeMutablePointer<Py_ssize_t>!) -> Int32
func _PySlice_AdjustIndices(_ length: Py_ssize_t, _ start: UnsafeMutablePointer<Py_ssize_t>!, _ stop: UnsafeMutablePointer<Py_ssize_t>!, _ step: Py_ssize_t) -> Py_ssize_t
