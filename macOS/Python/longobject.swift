...
func PyLong_FromVoidPtr(_: UnsafeMutableRawPointer!) -> UnsafeMutablePointer<PyObject>!
func PyLong_AsVoidPtr(_: UnsafeMutablePointer<PyObject>!) -> UnsafeMutableRawPointer!
...
func PyLong_FromString(_: UnsafeMutablePointer<CChar>!, _: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>!, _: Int32) -> UnsafeMutablePointer<PyObject>!
...
func _PyLong_FormatAdvanced(_ obj: UnsafeMutablePointer<PyObject>!, _ format_spec: UnsafeMutablePointer<CChar>!, _ format_spec_len: Py_ssize_t) -> UnsafeMutablePointer<PyObject>!
