...
func PyErr_SetString(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!)
...
func PyErr_SetFromErrnoWithFilename(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyErr_BadInternalCall()
func _PyErr_BadInternalCall(_ filename: UnsafePointer<CChar>!, _ lineno: Int32)
func PyErr_NewException(_ name: UnsafeMutablePointer<CChar>!, _ base: UnsafeMutablePointer<PyObject>!, _ dict: UnsafeMutablePointer<PyObject>!) -> UnsafeMutablePointer<PyObject>!
func PyErr_NewExceptionWithDoc(_ name: UnsafeMutablePointer<CChar>!, _ doc: UnsafeMutablePointer<CChar>!, _ base: UnsafeMutablePointer<PyObject>!, _ dict: UnsafeMutablePointer<PyObject>!) -> UnsafeMutablePointer<PyObject>!
...
func PyErr_SyntaxLocation(_: UnsafePointer<CChar>!, _: Int32)
func PyErr_ProgramText(_: UnsafePointer<CChar>!, _: Int32) -> UnsafeMutablePointer<PyObject>!
func PyUnicodeDecodeError_Create(_: UnsafePointer<CChar>!, _: UnsafePointer<CChar>!, _: Py_ssize_t, _: Py_ssize_t, _: Py_ssize_t, _: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyUnicodeEncodeError_Create(_: UnsafePointer<CChar>!, _: UnsafePointer<Py_UNICODE>!, _: Py_ssize_t, _: Py_ssize_t, _: Py_ssize_t, _: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyUnicodeTranslateError_Create(_: UnsafePointer<Py_UNICODE>!, _: Py_ssize_t, _: Py_ssize_t, _: Py_ssize_t, _: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
...
func PyUnicodeEncodeError_SetReason(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> Int32
func PyUnicodeDecodeError_SetReason(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> Int32
func PyUnicodeTranslateError_SetReason(_: UnsafeMutablePointer<PyObject>!, _: UnsafePointer<CChar>!) -> Int32
func PyOS_vsnprintf(_ str: UnsafeMutablePointer<CChar>!, _ size: Int, _ format: UnsafePointer<CChar>!, _ va: CVaListPointer) -> Int32
