...
func _PyDict_GetItemWithError(_ mp: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<PyObject>!) -> UnsafeMutablePointer<PyObject>!
...
func _PyDict_DelItemIf(_ mp: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<PyObject>!, _ predicate: (@convention(c) (UnsafeMutablePointer<PyObject>?) -> Int32)!) -> Int32
...
func PyDict_GetItemString(_ dp: UnsafeMutablePointer<PyObject>!, _ key: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyDict_SetItemString(_ dp: UnsafeMutablePointer<PyObject>!, _ key: UnsafePointer<CChar>!, _ item: UnsafeMutablePointer<PyObject>!) -> Int32
func PyDict_DelItemString(_ dp: UnsafeMutablePointer<PyObject>!, _ key: UnsafePointer<CChar>!) -> Int32
