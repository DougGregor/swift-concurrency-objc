...
struct PyCodeObject {
  ...
  var co_zombieframe: UnsafeMutableRawPointer!
  var co_weakreflist: UnsafeMutablePointer<PyObject>!
  init()
  init(ob_refcnt: Py_ssize_t, ob_type: UnsafeMutablePointer<_typeobject>!, co_argcount: Int32, co_nlocals: Int32, co_stacksize: Int32, co_flags: Int32, co_code: UnsafeMutablePointer<PyObject>!, co_consts: UnsafeMutablePointer<PyObject>!, co_names: UnsafeMutablePointer<PyObject>!, co_varnames: UnsafeMutablePointer<PyObject>!, co_freevars: UnsafeMutablePointer<PyObject>!, co_cellvars: UnsafeMutablePointer<PyObject>!, co_filename: UnsafeMutablePointer<PyObject>!, co_name: UnsafeMutablePointer<PyObject>!, co_firstlineno: Int32, co_lnotab: UnsafeMutablePointer<PyObject>!, co_zombieframe: UnsafeMutableRawPointer!, co_weakreflist: UnsafeMutablePointer<PyObject>!)
}
...
func PyCode_NewEmpty(_ filename: UnsafePointer<CChar>!, _ funcname: UnsafePointer<CChar>!, _ firstlineno: Int32) -> UnsafeMutablePointer<PyCodeObject>!
...
func _PyCode_ConstantKey(_ obj: UnsafeMutablePointer<PyObject>!) -> UnsafeMutablePointer<PyObject>!
