...
func PyBuffer_FromMemory(_ ptr: UnsafeMutableRawPointer!, _ size: Py_ssize_t) -> UnsafeMutablePointer<PyObject>!
func PyBuffer_FromReadWriteMemory(_ ptr: UnsafeMutableRawPointer!, _ size: Py_ssize_t) -> UnsafeMutablePointer<PyObject>!
