...
func _PyObject_LengthHint(_ o: UnsafeMutablePointer<PyObject>!, _: Py_ssize_t) -> Py_ssize_t
...
func PyObject_DelItemString(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<CChar>!) -> Int32
func PyObject_DelItem(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<PyObject>!) -> Int32
func PyObject_AsCharBuffer(_ obj: UnsafeMutablePointer<PyObject>!, _ buffer: UnsafeMutablePointer<UnsafePointer<CChar>?>!, _ buffer_len: UnsafeMutablePointer<Py_ssize_t>!) -> Int32
func PyObject_CheckReadBuffer(_ obj: UnsafeMutablePointer<PyObject>!) -> Int32
func PyObject_AsReadBuffer(_ obj: UnsafeMutablePointer<PyObject>!, _ buffer: UnsafeMutablePointer<UnsafeRawPointer?>!, _ buffer_len: UnsafeMutablePointer<Py_ssize_t>!) -> Int32
func PyObject_AsWriteBuffer(_ obj: UnsafeMutablePointer<PyObject>!, _ buffer: UnsafeMutablePointer<UnsafeMutableRawPointer?>!, _ buffer_len: UnsafeMutablePointer<Py_ssize_t>!) -> Int32
func PyObject_GetBuffer(_ obj: UnsafeMutablePointer<PyObject>!, _ view: UnsafeMutablePointer<Py_buffer>!, _ flags: Int32) -> Int32
func PyBuffer_GetPointer(_ view: UnsafeMutablePointer<Py_buffer>!, _ indices: UnsafeMutablePointer<Py_ssize_t>!) -> UnsafeMutableRawPointer!
func PyBuffer_SizeFromFormat(_: UnsafePointer<CChar>!) -> Int32
func PyBuffer_ToContiguous(_ buf: UnsafeMutableRawPointer!, _ view: UnsafeMutablePointer<Py_buffer>!, _ len: Py_ssize_t, _ fort: CChar) -> Int32
func PyBuffer_FromContiguous(_ view: UnsafeMutablePointer<Py_buffer>!, _ buf: UnsafeMutableRawPointer!, _ len: Py_ssize_t, _ fort: CChar) -> Int32
func PyObject_CopyData(_ dest: UnsafeMutablePointer<PyObject>!, _ src: UnsafeMutablePointer<PyObject>!) -> Int32
func PyBuffer_IsContiguous(_ view: UnsafeMutablePointer<Py_buffer>!, _ fort: CChar) -> Int32
func PyBuffer_FillContiguousStrides(_ ndims: Int32, _ shape: UnsafeMutablePointer<Py_ssize_t>!, _ strides: UnsafeMutablePointer<Py_ssize_t>!, _ itemsize: Int32, _ fort: CChar)
func PyBuffer_FillInfo(_ view: UnsafeMutablePointer<Py_buffer>!, _ o: UnsafeMutablePointer<PyObject>!, _ buf: UnsafeMutableRawPointer!, _ len: Py_ssize_t, _ readonly: Int32, _ flags: Int32) -> Int32
...
func _PyNumber_ConvertIntegralToInt(_ integral: UnsafeMutablePointer<PyObject>!, _ error_format: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
...
func PySequence_Fast(_ o: UnsafeMutablePointer<PyObject>!, _ m: UnsafePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
...
func PyMapping_HasKeyString(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<CChar>!) -> Int32
func PyMapping_HasKey(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<PyObject>!) -> Int32
func PyMapping_GetItemString(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<CChar>!) -> UnsafeMutablePointer<PyObject>!
func PyMapping_SetItemString(_ o: UnsafeMutablePointer<PyObject>!, _ key: UnsafeMutablePointer<CChar>!, _ value: UnsafeMutablePointer<PyObject>!) -> Int32
