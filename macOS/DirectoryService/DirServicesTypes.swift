...
struct tDirStatus : Equatable, RawRepresentable {
...
struct tDirPatternMatch : Equatable, RawRepresentable {
...
struct tDataBuffer {
  ...
  var fBufferData: (CChar)
  init()
  init(fBufferSize: UInt32, fBufferLength: UInt32, fBufferData: (CChar))
}
