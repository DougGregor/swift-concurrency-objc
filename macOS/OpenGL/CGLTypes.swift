...
struct _CGLPixelFormatAttribute : Equatable, RawRepresentable {
...
@available(macOS, introduced: 10.0, deprecated: 10.11, message: "OpenGL API deprecated. (Define GL_SILENCE_DEPRECATION to silence these warnings)")
var kCGLPFAStereo: _CGLPixelFormatAttribute { get }
typealias CGLPixelFormatAttribute = _CGLPixelFormatAttribute
struct _CGLRendererProperty : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
var kCGLRPRegistryIDLow: _CGLRendererProperty { get }
@available(macOS 10.13, *)
var kCGLRPRegistryIDHigh: _CGLRendererProperty { get }
@available(macOS 10.13, *)
var kCGLRPRemovable: _CGLRendererProperty { get }
typealias CGLRendererProperty = _CGLRendererProperty
struct _CGLContextEnable : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _CGLGPURestartStatus : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _CGLContextParameter : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct CGLCPContextPriorityRequest : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _CGLGlobalOption : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _CGLOpenGLProfile : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _CGLError : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
