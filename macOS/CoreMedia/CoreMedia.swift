...
protocol _CMAudioDeviceClockInitTrampoline {
  @available(macOS 10.15, macCatalyst 13.0, *)
  init(referencing: CMClock)
}
...
@available(tvOS, unavailable)
@available(watchOS, unavailable)
extension _CMAudioDeviceClockInitTrampoline {
  @available(macOS 10.15, macCatalyst 13.0, *)
  @available(iOS, unavailable)
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  init(audioDeviceUID: String?) throws
  @available(macOS 10.15, macCatalyst 13.0, *)
  @available(iOS, unavailable)
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  init(audioDeviceID: AudioDeviceID) throws
}
