...
class IOUSBHostPipe : IOUSBHostIOSource {
  ...
  func __enqueueControlRequestAsync(_ request: IOUSBDeviceRequest, data: NSMutableData?, completionTimeout: TimeInterval) async throws -> (IOReturn, Int)
  ...
  func enqueueIORequestAsync(with data: NSMutableData?, completionTimeout: TimeInterval) async throws -> (IOReturn, Int)
  ...
  func enqueueIORequestAsync(with data: NSMutableData, frameList: UnsafeMutablePointer<IOUSBHostIsochronousFrame>, frameListCount: Int, firstFrameNumber: UInt64) async throws -> (IOReturn, UnsafeMutablePointer<IOUSBHostIsochronousFrame>)
