...
typealias CMIODeviceGetSMPTETimeProc = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<UInt64>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<UInt32>?) -> OSStatus
@available(macOS 10.7, *)
struct CMIODeviceSMPTETimeCallback {
  var mGetSMPTETimeProc: CMIODeviceGetSMPTETimeProc!
  var mRefCon: UnsafeMutableRawPointer!
  init()
  init(mGetSMPTETimeProc: CMIODeviceGetSMPTETimeProc!, mRefCon: UnsafeMutableRawPointer!)
}
...
var kCMIODevicePropertyLocationUnknown: Int { get }
var kCMIODevicePropertyLocationBuiltInDisplay: Int { get }
var kCMIODevicePropertyLocationExternalDisplay: Int { get }
var kCMIODevicePropertyLocationExternalDevice: Int { get }
var kCMIODevicePropertyLocationExternalWirelessDevice: Int { get }
@available(macOS 10.7, *)
