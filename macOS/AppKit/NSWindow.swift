...
class NSWindow : NSResponder, NSAnimatablePropertyContainer, NSMenuItemValidation, NSUserInterfaceValidations, NSUserInterfaceItemIdentification, NSAppearanceCustomization, NSAccessibilityElementProtocol, NSAccessibilityProtocol {
  ...
  @available(macOS 10.9, *)
  func beginSheetAsync(_ sheetWindow: NSWindow) async -> NSApplication.ModalResponse
  @available(macOS 10.9, *)
  func beginCriticalSheet(_ sheetWindow: NSWindow, completionHandler handler: ((NSApplication.ModalResponse) -> Void)? = nil)
  @available(macOS 10.9, *)
  func beginCriticalSheetAsync(_ sheetWindow: NSWindow) async -> NSApplication.ModalResponse
  @available(macOS 10.9, *)
...
protocol NSWindowDelegate : NSObjectProtocol {
  ...
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidFailToEnterFullScreen(_ window: NSWindow)
  @available(macOS 10.7, *)
  ...
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidFailToExitFullScreen(_ window: NSWindow)
  @available(macOS 10.7, *)
  ...
  @available(macOS 10.7, *)
  @asyncHandler optional func window(_ window: NSWindow, didDecodeRestorableState state: NSCoder)
  @asyncHandler optional func windowDidResize(_ notification: Notification)
  @asyncHandler optional func windowDidExpose(_ notification: Notification)
  optional func windowWillMove(_ notification: Notification)
  @asyncHandler optional func windowDidMove(_ notification: Notification)
  @asyncHandler optional func windowDidBecomeKey(_ notification: Notification)
  @asyncHandler optional func windowDidResignKey(_ notification: Notification)
  @asyncHandler optional func windowDidBecomeMain(_ notification: Notification)
  @asyncHandler optional func windowDidResignMain(_ notification: Notification)
  optional func windowWillClose(_ notification: Notification)
  optional func windowWillMiniaturize(_ notification: Notification)
  @asyncHandler optional func windowDidMiniaturize(_ notification: Notification)
  @asyncHandler optional func windowDidDeminiaturize(_ notification: Notification)
  @asyncHandler optional func windowDidUpdate(_ notification: Notification)
  @asyncHandler optional func windowDidChangeScreen(_ notification: Notification)
  @asyncHandler optional func windowDidChangeScreenProfile(_ notification: Notification)
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidChangeBackingProperties(_ notification: Notification)
  optional func windowWillBeginSheet(_ notification: Notification)
  @asyncHandler optional func windowDidEndSheet(_ notification: Notification)
  @available(macOS 10.6, *)
  optional func windowWillStartLiveResize(_ notification: Notification)
  @available(macOS 10.6, *)
  @asyncHandler optional func windowDidEndLiveResize(_ notification: Notification)
  @available(macOS 10.7, *)
  optional func windowWillEnterFullScreen(_ notification: Notification)
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidEnterFullScreen(_ notification: Notification)
  @available(macOS 10.7, *)
  optional func windowWillExitFullScreen(_ notification: Notification)
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidExitFullScreen(_ notification: Notification)
  @available(macOS 10.7, *)
  optional func windowWillEnterVersionBrowser(_ notification: Notification)
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidEnterVersionBrowser(_ notification: Notification)
  @available(macOS 10.7, *)
  optional func windowWillExitVersionBrowser(_ notification: Notification)
  @available(macOS 10.7, *)
  @asyncHandler optional func windowDidExitVersionBrowser(_ notification: Notification)
  @available(macOS 10.9, *)
  @asyncHandler optional func windowDidChangeOcclusionState(_ notification: Notification)
}
extension NSWindow {
