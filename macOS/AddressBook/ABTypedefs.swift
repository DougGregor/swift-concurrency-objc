...
struct _ABPropertyType : Equatable, RawRepresentable {
...
struct _ABSearchComparison : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
...
struct _ABSearchConjunction : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
