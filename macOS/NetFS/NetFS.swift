...
var kNetFSOpenURLMountKey: String { get }
...
@available(macOS 10.8, *)
func NetFSMountURLAsync(_ url: CFURL!, _ mountpath: CFURL!, _ user: CFString!, _ passwd: CFString!, _ open_options: CFMutableDictionary!, _ mount_options: CFMutableDictionary!, _ requestID: UnsafeMutablePointer<AsyncRequestID?>!, _ dispatchq: DispatchQueue!, _ mount_report: NetFSMountURLBlock!) -> Int32
@available(macOS 10.8, *)
