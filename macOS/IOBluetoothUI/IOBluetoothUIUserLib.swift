...
class IOBluetoothDeviceSelectorControllerRef : _CFObject {
}
class IOBluetoothPairingControllerRef : _CFObject {
}
class IOBluetoothServiceBrowserControllerRef : _CFObject {
}
