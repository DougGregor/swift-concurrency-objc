...
class CFString : _CFObject {
}
class CFMutableString : CFString, _CFObject {
}
...
typealias CFComparatorFunction = @convention(c) (UnsafeRawPointer?, UnsafeRawPointer?, UnsafeMutableRawPointer?) -> CFComparisonResult
...
class CFNull : _CFObject {
}
func CFNullGetTypeID() -> CFTypeID
let kCFNull: CFNull!
class CFAllocator : _CFObject {
}
...
typealias CFAllocatorRetainCallBack = @convention(c) (UnsafeRawPointer?) -> UnsafeRawPointer?
typealias CFAllocatorReleaseCallBack = @convention(c) (UnsafeRawPointer?) -> Void
typealias CFAllocatorCopyDescriptionCallBack = @convention(c) (UnsafeRawPointer?) -> Unmanaged<CFString>?
typealias CFAllocatorAllocateCallBack = @convention(c) (CFIndex, CFOptionFlags, UnsafeMutableRawPointer?) -> UnsafeMutableRawPointer?
typealias CFAllocatorReallocateCallBack = @convention(c) (UnsafeMutableRawPointer?, CFIndex, CFOptionFlags, UnsafeMutableRawPointer?) -> UnsafeMutableRawPointer?
typealias CFAllocatorDeallocateCallBack = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutableRawPointer?) -> Void
typealias CFAllocatorPreferredSizeCallBack = @convention(c) (CFIndex, CFOptionFlags, UnsafeMutableRawPointer?) -> CFIndex
...
struct ptrauth_key : Equatable, RawRepresentable {
  init(_ rawValue: UInt32)
  init(rawValue: UInt32)
  var rawValue: UInt32
}
var ptrauth_key_asia: ptrauth_key { get }
var ptrauth_key_asib: ptrauth_key { get }
var ptrauth_key_asda: ptrauth_key { get }
var ptrauth_key_asdb: ptrauth_key { get }
var ptrauth_key_process_independent_code: ptrauth_key { get }
var ptrauth_key_process_dependent_code: ptrauth_key { get }
var ptrauth_key_process_independent_data: ptrauth_key { get }
var ptrauth_key_process_dependent_data: ptrauth_key { get }
var ptrauth_key_function_pointer: ptrauth_key { get }
var ptrauth_key_return_address: ptrauth_key { get }
var ptrauth_key_frame_pointer: ptrauth_key { get }
var ptrauth_key_block_function: ptrauth_key { get }
var ptrauth_key_cxx_vtable_pointer: ptrauth_key { get }
typealias ptrauth_extra_data_t = UInt
typealias ptrauth_generic_signature_t = UInt
