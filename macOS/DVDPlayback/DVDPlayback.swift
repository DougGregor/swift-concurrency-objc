...
typealias DVDEventCallBackRef = UnsafeMutableRawPointer
typealias DVDFatalErrCallBackFunctionPtr = @convention(c) (DVDErrorCode, UnsafeMutableRawPointer) -> Void
typealias DVDEventCallBackFunctionPtr = @convention(c) (DVDEventCode, DVDEventValue, DVDEventValue, UnsafeMutableRawPointer) -> Void
...
@available(macOS, introduced: 10.5, deprecated: 10.15, message: "No longer supported")
...
@available(macOS, introduced: 10.4, deprecated: 10.15, message: "No longer supported")
...
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDGetMediaVolumeName(_ outDiscVolumeName: UnsafeMutablePointer<UnsafeMutablePointer<CChar>>) -> OSStatus
@available(macOS, introduced: 10.4, deprecated: 10.15, message: "No longer supported")
...
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDGetBookmark(_ outBookMarkData: UnsafeMutableRawPointer?, _ ioBookMarkDataSize: UnsafeMutablePointer<UInt32>) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDGotoBookmark(_ inBookMarkData: UnsafeMutableRawPointer, _ inBookMarkDataSize: UInt32) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDGetLastPlayBookmark(_ outBookMarkData: UnsafeMutableRawPointer?, _ ioBookMarkDataSize: UnsafeMutablePointer<UInt32>) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDSetLastPlayBookmark(_ inBookMarkData: UnsafeMutableRawPointer, _ inBookMarkDataSize: UInt32) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
...
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDSetFatalErrorCallBack(_ inCallBackProc: DVDFatalErrCallBackFunctionPtr, _ inRefCon: UnsafeMutableRawPointer?) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
func DVDRegisterEventCallBack(_ inCallBackProc: DVDEventCallBackFunctionPtr, _ inCode: UnsafeMutablePointer<DVDEventCode>, _ inCodeCount: UInt32, _ inRefCon: UnsafeMutableRawPointer?, _ outCallBackID: UnsafeMutablePointer<DVDEventCallBackRef>) -> OSStatus
@available(macOS, introduced: 10.3, deprecated: 10.15, message: "No longer supported")
