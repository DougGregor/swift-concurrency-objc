...
class SecIdentity : _CFObject {
}
class SecKey : _CFObject {
}
class SecPolicy : _CFObject {
}
class SecAccessControl : _CFObject {
}
@available(macOS 10.0, *)
class SecKeychain : _CFObject {
}
class SecKeychainItem : _CFObject {
}
class SecKeychainSearch : _CFObject {
}
...
class SecTrustedApplication : _CFObject {
}
class SecAccess : _CFObject {
}
class SecACL : _CFObject {
}
class SecPassword : _CFObject {
}
...
@available(*, deprecated, message: "use errSecDiskFull")
...
var errSSLATSCiphersuiteViolation: OSStatus { get }
