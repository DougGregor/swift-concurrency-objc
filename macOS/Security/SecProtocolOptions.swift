...
@available(macOS, introduced: 10.14, deprecated: 10.15, message: "Use sec_protocol_options_append_tls_ciphersuite")
...
@available(macOS, introduced: 10.14, deprecated: 10.15, message: "Use sec_protocol_options_append_tls_ciphersuite_group")
func sec_protocol_options_add_tls_ciphersuite_group(_ options: sec_protocol_options_t, _ group: SSLCiphersuiteGroup)
@available(macOS, introduced: 10.14, deprecated: 10.15, renamed: "sec_protocol_options_set_min_tls_protocol_version(_:_:)")
...
@available(macOS, introduced: 10.14, deprecated: 10.15, renamed: "sec_protocol_options_set_max_tls_protocol_version(_:_:)")
...
@available(macOS, introduced: 10.14, deprecated: 10.15, message: "DHE ciphersuites are no longer supported")
