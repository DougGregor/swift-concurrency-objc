...
@available(macOS, introduced: 10.14, deprecated: 10.15, renamed: "sec_protocol_metadata_get_negotiated_tls_protocol_version(_:)")
...
@available(macOS, introduced: 10.14, deprecated: 10.15, renamed: "sec_protocol_metadata_get_negotiated_tls_ciphersuite(_:)")
