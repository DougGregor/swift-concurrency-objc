...
@available(iOS, introduced: 6.0, deprecated: 9.0, renamed: "CMTimebaseCopyMasterTimebase(_:)")
func CMTimebaseGetMasterTimebase(_ timebase: CMTimebase) -> CMTimebase?
@available(iOS, introduced: 6.0, deprecated: 9.0, renamed: "CMTimebaseCopyMasterClock(_:)")
func CMTimebaseGetMasterClock(_ timebase: CMTimebase) -> CMClock?
@available(iOS, introduced: 6.0, deprecated: 9.0, renamed: "CMTimebaseCopyMaster(_:)")
func CMTimebaseGetMaster(_ timebase: CMTimebase) -> CMClockOrTimebase?
@available(iOS, introduced: 6.0, deprecated: 9.0, renamed: "CMTimebaseCopyUltimateMasterClock(_:)")
