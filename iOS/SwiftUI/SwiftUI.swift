...
struct GroupedListStyle : ListStyle {
  init()
  static func _sectionInset(_ sectionInset: EdgeInsets) -> GroupedListStyle
}
...
protocol IndexViewStyle {
  associatedtype _Body : View
  func _makeBody(configuration: Self._Configuration) -> Self._Body
...
extension View {
  ...
  @available(macOS, unavailable)
  @available(watchOS, unavailable)
  @inlinable func textContentType(_ textContentType: UITextContentType?) -> some View
...
extension View {
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  @_disfavoredOverload func navigationBarTitle<S>(_ title: S, displayMode: NavigationBarItem.TitleDisplayMode) -> some View where S : StringProtocol
...
@available(macOS, unavailable)
@available(watchOS, unavailable)
struct _IndexViewStyleConfiguration {
}
