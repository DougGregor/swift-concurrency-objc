...
@available(iOS, introduced: 2.0, deprecated: 8.0, message: "Use CFPropertyListCreateData instead.")
...
@available(iOS, introduced: 2.0, deprecated: 8.0, message: "Use CFPropertyListCreateWithStream instead.")
