...
@available(iOS, introduced: 4.0, deprecated: 10.0, message: "Use NSURLLabelColorKey")
let kCFURLLabelColorKey: CFString!
@available(iOS 4.0, *)
let kCFURLLocalizedLabelKey: CFString!
@available(iOS, introduced: 4.0, deprecated: 10.0, message: "Use NSURLEffectiveIconKey")
let kCFURLEffectiveIconKey: CFString!
@available(iOS, introduced: 4.0, deprecated: 10.0, message: "Use NSURLCustomIconKey")
