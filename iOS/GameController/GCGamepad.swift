...
@available(iOS, introduced: 7.0, deprecated: 10.0, renamed: "GCExtendedGamepad")
...
@available(iOS, introduced: 7.0, deprecated: 10.0, message: "GCGamepad has been deprecated")
