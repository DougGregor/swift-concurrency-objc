...
extension INSendMessageIntent {
  ...
  @available(iOS, introduced: 11.0, deprecated: 14.0, message: "Use the designated initializer with outgoingMessageType instead")
  ...
  @available(iOS, introduced: 14.0, deprecated: 14.0, message: "Use the designated initializer with attachments instead instead")
