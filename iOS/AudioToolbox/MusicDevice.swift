...
typealias MusicDeviceMIDIEventProc = @convention(c) (UnsafeMutableRawPointer, UInt32, UInt32, UInt32, UInt32) -> OSStatus
typealias MusicDeviceSysExProc = @convention(c) (UnsafeMutableRawPointer, UnsafePointer<UInt8>, UInt32) -> OSStatus
typealias MusicDeviceStartNoteProc = @convention(c) (UnsafeMutableRawPointer, MusicDeviceInstrumentID, MusicDeviceGroupID, UnsafeMutablePointer<NoteInstanceID>, UInt32, UnsafePointer<MusicDeviceNoteParams>) -> OSStatus
typealias MusicDeviceStopNoteProc = @convention(c) (UnsafeMutableRawPointer, MusicDeviceGroupID, NoteInstanceID, UInt32) -> OSStatus
