...
typealias HostCallback_GetBeatAndTempo = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<Float64>?, UnsafeMutablePointer<Float64>?) -> OSStatus
typealias HostCallback_GetMusicalTimeLocation = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<Float32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<Float64>?) -> OSStatus
typealias HostCallback_GetTransportState = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<Float64>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<Float64>?, UnsafeMutablePointer<Float64>?) -> OSStatus
typealias HostCallback_GetTransportState2 = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<Float64>?, UnsafeMutablePointer<DarwinBoolean>?, UnsafeMutablePointer<Float64>?, UnsafeMutablePointer<Float64>?) -> OSStatus
...
typealias AUMIDIOutputCallback = @convention(c) (UnsafeMutableRawPointer?, UnsafePointer<AudioTimeStamp>, UInt32, UnsafePointer<MIDIPacketList>) -> OSStatus
...
struct AudioOutputUnitMIDICallbacks {
  var userData: UnsafeMutableRawPointer?
  var MIDIEventProc: @convention(c) (UnsafeMutableRawPointer?, UInt32, UInt32, UInt32, UInt32) -> Void
  var MIDISysExProc: @convention(c) (UnsafeMutableRawPointer?, UnsafePointer<UInt8>, UInt32) -> Void
  init(userData: UnsafeMutableRawPointer?, MIDIEventProc: @convention(c) (UnsafeMutableRawPointer?, UInt32, UInt32, UInt32, UInt32) -> Void, MIDISysExProc: @convention(c) (UnsafeMutableRawPointer?, UnsafePointer<UInt8>, UInt32) -> Void)
}
...
enum AUSpatializationAlgorithm : UInt32 {
  ...
  case spatializationAlgorithm_UseOutputType
}
enum AUSpatialMixerSourceMode : UInt32 {
  init?(rawValue: UInt32)
  var rawValue: UInt32 { get }
  case spatialMixerSourceMode_SpatializeIfMono
  case spatialMixerSourceMode_Bypass
  case spatialMixerSourceMode_PointSource
...
enum AUSpatialMixerPointSourceInHeadMode : UInt32 {
  init?(rawValue: UInt32)
  var rawValue: UInt32 { get }
...
typealias ScheduledAudioSliceCompletionProc = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<ScheduledAudioSlice>) -> Void
...
typealias ScheduledAudioFileRegionCompletionProc = @convention(c) (UnsafeMutableRawPointer?, UnsafeMutablePointer<ScheduledAudioFileRegion>, OSStatus) -> Void
