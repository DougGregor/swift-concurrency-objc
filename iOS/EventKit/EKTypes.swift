...
@frozen enum EKWeekday : Int {
  ...
  case friday
  case saturday
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdaySunday instead")
  static var EKSunday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdayMonday instead")
  static var EKMonday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdayTuesday instead")
  static var EKTuesday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdayWednesday instead")
  static var EKWednesday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdayThursday instead")
  static var EKThursday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdayFriday instead")
  static var EKFriday: EKWeekday { get }
  @available(iOS, introduced: 4.0, deprecated: 9.0, message: "Use EKWeekdaySaturday instead")
