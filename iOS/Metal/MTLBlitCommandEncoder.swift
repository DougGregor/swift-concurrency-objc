...
protocol MTLBlitCommandEncoder : MTLCommandEncoder {
  ...
  @available(iOS 13.0, *)
  func getTextureAccessCounters(_ texture: MTLTexture, region: MTLRegion, mipLevel: Int, slice: Int, resetCounters: Bool, countersBuffer: MTLBuffer, countersBufferOffset: Int)
  @available(iOS 13.0, *)
  func resetTextureAccessCounters(_ texture: MTLTexture, region: MTLRegion, mipLevel: Int, slice: Int)
  @available(iOS 12.0, *)
