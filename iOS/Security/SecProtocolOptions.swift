...
@available(iOS, introduced: 12.0, deprecated: 13.0, message: "Use sec_protocol_options_append_tls_ciphersuite")
...
@available(iOS, introduced: 12.0, deprecated: 13.0, message: "Use sec_protocol_options_append_tls_ciphersuite_group")
func sec_protocol_options_add_tls_ciphersuite_group(_ options: sec_protocol_options_t, _ group: SSLCiphersuiteGroup)
@available(iOS, introduced: 12.0, deprecated: 13.0, renamed: "sec_protocol_options_set_min_tls_protocol_version(_:_:)")
...
@available(iOS, introduced: 12.0, deprecated: 13.0, renamed: "sec_protocol_options_set_max_tls_protocol_version(_:_:)")
...
@available(iOS, introduced: 12.0, deprecated: 13.0, message: "DHE ciphersuites are no longer supported")
