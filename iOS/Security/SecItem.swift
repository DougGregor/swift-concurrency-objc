...
@available(iOS, introduced: 2.0, deprecated: 12.0, message: "Not implemented on this platform")
let kSecUseItemList: CFString
@available(iOS, introduced: 8.0, deprecated: 14.0, message: "Use kSecUseAuthenticationContext and set LAContext.localizedReason property")
let kSecUseOperationPrompt: CFString
@available(iOS, introduced: 8.0, deprecated: 9.0, message: "Use kSecUseAuthenticationUI instead.")
...
@available(iOS, introduced: 9.0, deprecated: 14.0, message: "Instead of kSecUseAuthenticationUI, use kSecUseAuthenticationContext and set LAContext.interactionNotAllowed property")
