...
struct PHAssetMediaSubtype : OptionSet {
  ...
  @available(iOS 13, *)
  static var spatialOverCapture: PHAssetMediaSubtype { get }
  @available(iOS 8, *)
...
enum PHAssetResourceType : Int {
  ...
  @available(iOS 13, *)
  case spatialOverCapturePhoto
  @available(iOS 13, *)
  case spatialOverCaptureVideo
  @available(iOS 13, *)
  case spatialOverCapturePairedVideo
  @available(iOS 13, *)
  case originalAdjustmentData
}
