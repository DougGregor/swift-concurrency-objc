...
class SCNView : UIView, SCNSceneRenderer, SCNTechniqueSupport {
  ...
  @available(iOS, introduced: 8.0, deprecated: 12.0, message: "OpenGL API deprecated, please use Metal instead. (Define SCN_SILENCE_GL_DEPRECATION to silence these warnings)")
