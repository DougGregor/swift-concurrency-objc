...
protocol SCNAnimatable : NSObjectProtocol {
  ...
  @available(iOS, introduced: 8.0, deprecated: 11.0, message: "Use -[SCNAnimationPlayer setPaused:] instead")
  func pauseAnimation(forKey key: String)
  @available(iOS, introduced: 8.0, deprecated: 11.0, message: "Use -[SCNAnimationPlayer setPaused:] instead")
  func resumeAnimation(forKey key: String)
  @available(iOS, introduced: 10.0, deprecated: 11.0, message: "Use -[SCNAnimationPlayer setSpeed:] instead")
  func setAnimationSpeed(_ speed: CGFloat, forKey key: String)
  @available(iOS, introduced: 8.0, deprecated: 11.0, message: "Use -[SCNAnimationPlayer paused] instead")
