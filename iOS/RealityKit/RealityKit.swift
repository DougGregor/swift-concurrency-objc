...
@objc class ARView : ARViewBase {
  ...
  convenience init(frame frameRect: CGRect, cameraMode: ARView.CameraMode)
  init(frame frameRect: CGRect, cameraMode: ARView.CameraMode, automaticallyConfigureSession: Bool)
  ...
  static func __queryModelIdentifier() -> String
  static var __nonARKitModelIdentifiers: [String] { get }
  var __disableCounterRotation: Bool
  ...
  func __distanceInMetersFromEntity(_ entity: Entity) -> Float
}

extension ARView {
  struct RenderOptions : OptionSet {
  ...
  var __renderQuality: ARView.__RenderQuality
}

extension ARView {
  struct EntityGestures : OptionSet {
  ...
  struct Environment {
    ...
    struct SceneUnderstanding {
      struct Options : OptionSet {
        ...
        static let __disableFeathering: ARView.Environment.SceneUnderstanding.Options
        static let __disableGuidedFilterOcclusions: ARView.Environment.SceneUnderstanding.Options
        static let `default`: ARView.Environment.SceneUnderstanding.Options
      }
      struct __InternalSettings {
        var guidedFilterOcclusionUseSingleMTLEvent: Bool
      }
      var __internalSettings: ARView.Environment.SceneUnderstanding.__InternalSettings
...
extension ARView {
  ...
  func makeRaycastQuery(from point: CGPoint, allowing target: ARRaycastQuery.Target, alignment: ARRaycastQuery.TargetAlignment) -> ARRaycastQuery?
...
extension ARView : ARSessionProviding {
  ...
  var __passthroughTextureY: MTLTexture? { get }
  var __passthroughTextureCbCr: MTLTexture? { get }
  var __passthroughCorrectionMatrix: float4x4 { get }
  var __passthroughIntensityExponent: Float
  var __backgroundReplacementBuffer: CVPixelBuffer?
  var __enableUpdateCameraWorldMatrixFromARFrame: Bool
  var __enableUpdateCameraProjectionMatrixFromARFrame: Bool
  var __fallbackAmbientIntensity: Float
  var __fallbackAmbientColor: PointLightComponent.Color
  var __autoFireStartTriggerOnPlacement: Bool
  func __enableRayTracedGroundingShadow()
  func __disableRayTracedGroundingShadow()
  static func __clusterSceneBoxes(sceneAABBs: inout [BoundingBox])
}

extension ARView {
  @discardableResult
  func __occlusionEntity(for faceAnchor: ARFaceAnchor) -> Entity?
  func __removeOcclusionEntity(for faceAnchor: ARFaceAnchor)
}
...
extension ARView : UIGestureRecognizerDelegate {
  func __enablePauseEngineOnLeaveForeground()
  func __disablePauseEngineOnLeaveForeground()
}
...
struct AnchoringComponent : Component, Equatable {
  enum Target : Hashable {
    ...
    struct Classification : OptionSet {
...
@available(macOS 10.15, iOS 13.0, *)
class BodyTrackedEntity : Entity, HasBodyTracking, HasModel {
}

@available(macOS 10.15, iOS 13.0, *)
struct BodyTrackingComponent : Component, Equatable {
  enum Target : Hashable {
    case any
...
extension Entity {
  ...
  func __accessibilityWrappers(rootEntityWrapper: __EntityAccessibilityWrapper? = nil) -> [__EntityAccessibilityWrapper]
  func __calculateScreenBoundingRect(in arView: ARView) -> CGRect
}
...
extension Entity {
  ...
  static func loadBodyTracked(named name: String, in bundle: Bundle? = nil) throws -> BodyTrackedEntity
  static func loadBodyTrackedAsync(named name: String, in bundle: Bundle? = nil) -> LoadRequest<BodyTrackedEntity>
  static func loadBodyTracked(contentsOf url: URL, withName resourceName: String? = nil) throws -> BodyTrackedEntity
  static func loadBodyTrackedAsync(contentsOf url: URL, withName resourceName: String? = nil) -> LoadRequest<BodyTrackedEntity>
...
@available(macOS 10.15, iOS 13.0, *)
@objc class EntityRotationGestureRecognizer : UIRotationGestureRecognizer, EntityGestureRecognizer {
}

@available(macOS 10.15, iOS 13.0, *)
@objc class EntityScaleGestureRecognizer : UIPinchGestureRecognizer, EntityGestureRecognizer {
}

@available(macOS 10.15, iOS 13.0, *)
@objc class EntityTranslationGestureRecognizer : UIGestureRecognizer, EntityGestureRecognizer {
  func translation(in entity: Entity?) -> SIMD3<Float>?
  func setTranslation(_ translation: SIMD3<Float>, in entity: Entity?)
...
extension HasSceneUnderstanding {
  var sceneUnderstanding: SceneUnderstandingComponent { get }
}
...
extension MeshResource {
  static func __generateFace(from faceGeometry: ARFaceGeometry, fillMesh: Bool = true) -> MeshResource
}
...
@available(iOS 13.4, *)
struct SceneUnderstandingComponent : Component {
}
...
protocol __ARReferenceProviding {
  func fetchReferenceObject(group: String, name: String) -> ARReferenceObject?
  func fetchReferenceImage(group: String, name: String, physicalWidth: CGFloat) -> ARReferenceImage?
}
...
@available(macOS 10.15.4, iOS 13.4, *)
@objc class __EntityAccessibilityWrapper : NSObject {
}
...
extension __REAnchoringType {
  func isEqualToARAnchor(anchor: ARAnchor) -> Bool
}
...
extension __SceneImportOperation {
  ...
  final func makeBodyTrackedEntity() throws -> BodyTrackedEntity
}
