...
protocol WKNavigationDelegate : NSObjectProtocol {
  ...
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didStartProvisionalNavigation navigation: WKNavigation!)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didReceiveServerRedirectForProvisionalNavigation navigation: WKNavigation!)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didFailProvisionalNavigation navigation: WKNavigation!, withError error: Error)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didCommit navigation: WKNavigation!)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didFail navigation: WKNavigation!, withError error: Error)
  @available(iOS 8.0, *)
  @asyncHandler optional func webView(_ webView: WKWebView, didReceive challenge: URLAuthenticationChallenge, completionHandler: @escaping (URLSession.AuthChallengeDisposition, URLCredential?) -> Void)
  @available(iOS 8.0, *)
  ...
  @available(iOS 9.0, *)
  @asyncHandler optional func webViewWebContentProcessDidTerminate(_ webView: WKWebView)
  @available(iOS 14.0, *)
